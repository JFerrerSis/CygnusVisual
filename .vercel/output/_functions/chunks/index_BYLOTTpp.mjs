...
import require$$2 from 'semver/functions/coerce.js';
import require$$3 from 'semver/functions/gte.js';
import require$$4 from 'semver/functions/satisfies.js';
...
function requireLibvips () {
	...
	const semverCoerce = require$$2;
	const semverGreaterThanOrEqualTo = require$$3;
	const semverSatisfies = require$$4;
	const detectLibc = require$$5;
...
function requireSharp () {
	...
	const { familySync, versionSync } = require$$5;
