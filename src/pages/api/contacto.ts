  ...
  html: `
    ...
    <body>
      <div class="email-container">
        ...
        <div class="footer">
          <p class="footer-text">© ${new Date().getFullYear()} Cygnus Visual</p>
    ...
    <body>
      <div class="email-container">
        ...
        <div class="content">
          ...
          <div class="message-text">
            ${language === 'es' 
              ? 'Hemos recibido tu mensaje correctamente. Uno de nuestros asesores te responderá a la brevedad posible.' 
              : 'We have received your message. One of our advisors will get back to you as soon as possible.'}
          </div>
